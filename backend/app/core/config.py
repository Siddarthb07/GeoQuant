...
class Settings(BaseSettings):
    ...
    yfinance_symbol_aliases: Dict[str, str] = Field(
        default_factory=lambda: {
            # Tata Motors demerged Oct 2025; passenger vehicle line trades as TMPV.
...
def resolve_yfinance_symbol(symbol: str) -> str:
    ...
    return settings.yfinance_symbol_aliases.get(normalized, normalized)
